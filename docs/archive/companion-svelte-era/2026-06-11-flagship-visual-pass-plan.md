...
**Visual mockups (interactive + PNG):** `docs/flagship-visual-mockups/` — HTML prototypes and screenshots; **start with** `05-compare-before-after.html`

**Competitive reference pack:** `docs/flagship-visual-mockups/screenshots/baseline/` (production Sully + Gemini; ChatGPT/Claude capture notes below)
