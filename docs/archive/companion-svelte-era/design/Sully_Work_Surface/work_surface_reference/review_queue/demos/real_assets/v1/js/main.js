/* ==========================================================================
   SULLY WORK SURFACE - REAL ASSETS V1 ENGINE
   ========================================================================== */
...
function renderGraph(svgId, preset) {
	...
	// Clear existing items (retains global defs since they are in HTML body, not the card SVGs!)
	svg.innerHTML = '';
	...
	activeWorkers.forEach((w, idx) => {
		...
		// Centers the 22x22 icon beautifully inside the 34x34 circle
