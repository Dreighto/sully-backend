...
_(Note: Assets are compiled inline inside the JS logic block to allow instant offline rendering over the local `file://` protocol, avoiding CORS constraints when fetching external icons.)_
