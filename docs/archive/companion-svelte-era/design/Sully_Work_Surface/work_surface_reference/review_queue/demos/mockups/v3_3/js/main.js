/* ==========================================================================
   SULLY WORK SURFACE MOTION MOCKUP ENGINE - v3.3 SEMANTIC PAYLOADS
   ========================================================================== */

// 1. INLINED SVG DEFINITIONS FOR LOCAL FILE STANDALONE RENDERING
// Upgraded to generic <symbol viewBox="0 0 24 24"> so <use> size scaling works natively.
const SVG_DEFS = `
<defs>
  <!-- Worker Icons -->
  <symbol id="icon-claude" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M19 9h2v2h-2v2h-1v2h-1v-2h-1v2h-1v-2h-4v2H9v-2H8v2H7v-2H6v-2H4V9h2V5h13v4zM8 9h1V7H8v2zm7 0h1V7h-1v2z"/></symbol>
  <symbol id="icon-antigravity" viewBox="0 0 24 24"><path fill="currentColor" d="M19.5 19.5c1 .8 2.5.3 1-.8-4.2-4.1-3.3-15.3-8.5-15.3S8.7 14.6 4.5 18.7c-1.5 1.1 0 1.5 1 .8 3.9-2.7 3.6-7.4 7.3-7.4s6.7 4.7 6.7 7.4z"/></symbol>
  <symbol id="icon-codex" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm-2.8 11.2a1 1 0 0 1-1.6 1l-2-3.4a1 1 0 0 1 0-1l2-3.4a1 1 0 0 1 1.6 1L8 12.3zm6.8 1.8h-4a1 1 0 0 1 0-2h4a1 1 0 0 1 0 2z"/></symbol>
  <symbol id="icon-gemini" viewBox="0 0 24 24"><path fill="currentColor" d="M11 18.2q.9 2 .9 4.3 0-2.3.9-4.3t2.6-3.6 3.6-2.5q2-.9 4.3-.9-2.3 0-4.3-.9a11 11 0 0 1-3.6-2.6 11 11 0 0 1-2.6-3.6Q12 2.3 12 0q0 2.3-1 4.3-.9 2-2.5 3.6a11 11 0 0 1-3.6 2.6Q2.3 11 0 11q2.3 0 4.3 1 2 .9 3.6 2.5t2.5 3.6"/></symbol>
  <symbol id="icon-deepseek" viewBox="0 0 24 24"><path fill="currentColor" d="M22 6.5c-.2-.1-.3.1-.4.2 0 .1 0 .1-.1.2-.3.3-.6.5-1.1.5-.7-.1-1.3.1-1.8.7-.1-.7-.5-1.1-1.1-1.4-.3-.1-.6-.2-.8-.5-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6-.1-.2-.2-.4-.3-.6L12 18c-1.7-1.3-2.5-1.8-2.9-1.8-.3 0-.3.4-.2.6v.7c.1.2.2.5-.1.7-.5.3-1.5-.1-1.5-.1-1.1-.7-2-1.5-2.6-2.7-.6-1.2-1-2.4-1.1-3.7 0-.3.1-.4.4-.5.4-.1.8-.1 1.2-.1 1.7.3 3.1 1.1 4.3 2.3.7.7 1.2 1.5 1.8 2.3.6.9 1.2 1.7 2 2.4.3.2.5.4.7.6-.6.1-1.6.1-2.3-.7z"/></symbol>
  
  <!-- System Icons -->
  <symbol id="icon-memory" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2A10 10 0 1 0 22 12A10 10 0 0 0 12 2zm1 14h-2v-2h2zm0-4h-2V7h2z"/></symbol>
  <symbol id="icon-verify" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2L4 5v7c0 5.2 3.4 10.1 8 11.3 4.6-1.2 8-6.1 8-11.3V5l-8-3zm-1 15l-4-4 1.4-1.4 2.6 2.6 6.6-6.6 1.4 1.4-8 8z"/></symbol>
  <symbol id="icon-approval" viewBox="0 0 24 24"><path fill="currentColor" d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-1 7V3.5L18.5 9H13zM8 12h8v2H8v-2zm0 4h8v2H8v-2z"/></symbol>
  <symbol id="icon-dispatch" viewBox="0 0 24 24"><circle cx="5" cy="12" r="2.5" fill="currentColor"/><circle cx="19" cy="5" r="2.5" fill="currentColor"/><circle cx="19" cy="12" r="2.5" fill="currentColor"/><circle cx="19" cy="19" r="2.5" fill="currentColor"/><path d="M8 10.5l8-3.5M8 12h8M8 13.5l8 3.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></symbol>
  <symbol id="icon-blocked" viewBox="0 0 24 24"><path fill="currentColor" d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8 0-1.8.6-3.5 1.7-4.9L16.9 18.3c-1.4 1.1-3.1 1.7-4.9 1.7zm5.3-3.1L6.7 6.7C8.1 5.6 9.8 5 12 5c4.4 0 8 3.6 8 8 0 1.8-.6 3.5-1.7 4.9z"/></symbol>
  <symbol id="icon-task" viewBox="0 0 24 24"><path fill="currentColor" d="M19 3h-4.2a3 3 0 0 0-5.6 0H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zm-7 0a1 1 0 1 1-1 1 1 1 0 0 1 1-1zm2 14H8v-2h6zm4-4H8v-2h10z"/></symbol>
  
  <!-- Semantic Payloads (v3.3) -->
  <symbol id="payload-researching" viewBox="0 0 24 24">
    <!-- Context gathering / radar blips -->
    <circle cx="12" cy="12" r="4" fill="currentColor"/>
    <circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="2" stroke-dasharray="2 4"/>
  </symbol>
  <symbol id="payload-building" viewBox="0 0 24 24">
    <!-- Output generation / Code block shard -->
    <path fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M9 8l-4 4 4 4m6-8l4 4-4 4M14 4l-4 16"/>
  </symbol>
  <symbol id="payload-verifying" viewBox="0 0 24 24">
    <!-- QA / Logic token (Shield + check) -->
    <path fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
    <path fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4"/>
  </symbol>
</defs>
`;
