...
- Staggered glide packets (`.data-packet.animating`) run *only* along paths that belong to this active route. Packets are completely hidden on completed or idle worker paths.
