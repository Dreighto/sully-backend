...
- **Kernel hardening ([LOS-148], High)** — schedule the dedicated task: the dispatch listener crashes on an uncaught park-check throw. Full worker workspace dispatch isn't fully hardened until this lands. (Parked from 5a; acceptance test in the validation doc.)
